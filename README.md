...
<img width="831" height="279" alt="image" src="https://github.com/user-attachments/assets/3890208d-cf5e-4e1c-ae4e-d2ec2b43e551" />
...
1. В меню выбрать "Проект" -> "Управление пакетами NuGet"

2. Перейти на вкладку "Обзор"

3. В строку поиска ввести "BCrypt.Net-Next"

4. Выбрать пакет с автором "bcrypt-net-next"
...
1. Открыть "Сервис" -> "Диспетчер пакетов NuGet" -> "Консоль диспетчера пакетов"

2. Ввести команду: Install-Package BCrypt.Net-Next
